...
REM Start ENHANCED Pathway Streaming Engine (Port 8000) - CRITICAL!
echo [1/4] Starting ENHANCED Pathway Streaming Engine...
start "Enhanced Pathway (Port 8000)" cmd /k "cd /d %~dp0backend && python pathway_streaming_enhanced.py"
